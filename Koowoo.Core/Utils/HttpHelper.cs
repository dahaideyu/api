...
namespace Koowoo.Core
{
    ...
    public class HttpHelper
    {
        ...
        public HttpHelper(string token, string uriString = "")
           : this(uriString)
        {
        ...
        public T Get<T>(Dictionary<string, object> parameters, string requestUri) where T : class
        {
        ...
        /// <param name="requestUri">例如/api/Files/UploadFile</param>
        /// <returns></returns>
        public string CurrentPost(object entity, string requestUri)
        {
        ...
        public T Post<T>(object entity, string requestUri)
        {
            string request = string.Empty;
            if (entity != null)
                request = JsonConvert.SerializeObject(entity);
            HttpContent httpContent = new StringContent(request);
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
            string jsonString= Post(requestUri, httpContent);
        ...
        public T Put<T>(object entity, string requestUri)
        {
            string request = string.Empty;
            if (entity != null)
                request = JsonConvert.SerializeObject(entity);
            HttpContent httpContent = new StringContent(request);
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
            string jsonString = Put(requestUri, httpContent);
        ...
        /// <returns></returns>
        public T Delete<T>(object entity, string requestUri)
        {
            string request = string.Empty;
            if (entity != null)
                request = JsonConvert.SerializeObject(entity);
            HttpContent httpContent = new StringContent(request);
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
            string jsonString = Delete(requestUri, httpContent);
        ...
        /// <param name="requestUri">例如/api/Files/UploadFile</param>
        /// <returns></returns>
        public string Delete(object entity, string requestUri)
        {
            string request = string.Empty;
            if (entity != null)
                request = JsonConvert.SerializeObject(entity);
            HttpContent httpContent = new StringContent(request);
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
            return Delete(requestUri, httpContent);
        }


        private string Delete(string requestUrl, HttpContent content)
        {
            var result = _httpClient.DeleteAsync(ConcatURL(requestUrl));
            return result.Result.Content.ReadAsStringAsync().Result;
        }
        /// <summary>
        /// 把请求的URL相对路径组合成绝对路径
